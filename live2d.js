    ...
    o.prototype.load = function(t, i, e) {
        ...
        this.modelSetting.loadModelSetting(i, function() {
            ...
            r.loadModelData(t, function(t) {
                if (r.modelSetting.json.textures_random) {
                    let next_textures = Math.floor(Math.random()*r.modelSetting.json.textures.length);
                    if (next_textures != 0) {
                        let tmp = r.modelSetting.json.textures[0];
                        r.modelSetting.json.textures[0] = r.modelSetting.json.textures[next_textures];
                        r.modelSetting.json.textures[next_textures] = tmp;
                    }
                }
                for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
                    ...
                    if (r.modelSetting.json.textures_random) break;
                }
            })
        })
    }
